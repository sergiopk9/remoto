				...
				<div class="table-wrapper">
					<table class="alt">
						...
						<tbody>
							...
							%>
							<tr>
								<td width='60' rowspan="2" style="text-align: center;"><a
									href="liga.jsp?Cod_liga=<%=liga.getCod_liga()%>"><img
										src="images/ligas/<%=liga.getCod_liga()%>.png" width="48px"
										height="48px" title="<%=liga.getNombre()%>"></a></td>

								<td width='300' colspan="3" style="padding-left: 15px;"><a
									href="liga.jsp?Cod_liga=<%=liga.getCod_liga()%>"><%=liga.getNombre()%></a></td>
								<%
								for (Equipo equipo : controladorBD.dameEquiposSegunLiga(liga.getCod_liga())) {
								%>
							...
							<tr>
								<td width='50' style="text-align: center; padding-left: 14px;"><img
									src="images/paises/<%=liga.getPais()%>.png" width="40"
									height="40" title="<%=liga.getPais()%>"></td>
								<td width='205' style="text-align: center;">vacío</td>
							</tr>
							<%
							}
							%>
