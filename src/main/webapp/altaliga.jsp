			...
			<div id="content">
				...
				<form action="operaciones.jsp?tipo=AltaLiga" method="post">
					<div class="row gtr-50">
						...
						<div class="">
							<input type="text" name="nombre_liga" id="nombre_liga"
								placeholder="Nombre de la liga" maxlength="20" />
						</div>
						<div class="">
							<input type="text" name="pais_liga" id="pais_liga"
								placeholder="Pais de la liga" maxlength="20" />
						</div>
